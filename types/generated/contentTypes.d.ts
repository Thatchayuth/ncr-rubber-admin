...
export interface ApiDashboardNewsItemDashboardNewsItem
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ExpDate: Schema.Attribute.DateTime;
    isPinned: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dashboard-news-item.dashboard-news-item'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiNewsCategoryNewsCategory
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dashboard_news_item: Schema.Attribute.Relation<
      'oneToOne',
      'api::dashboard-news-item.dashboard-news-item'
    >;
...
export interface ApiNewsTagNewsTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dashboard_news_items: Schema.Attribute.Relation<
      'manyToMany',
      'api::dashboard-news-item.dashboard-news-item'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dashboard-news-item.dashboard-news-item': ApiDashboardNewsItemDashboardNewsItem;
